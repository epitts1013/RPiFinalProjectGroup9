...
def chooseDifficulty():
	...
	if (diff == "Easy"):
		...
		print "I don't understand. Please choose an availible difficulty (Easy, Medium, Hard)"
		chooseDifficulty()
...
class SudokuPuzzle(Frame):
	...
	def __init__(self, master, puzzle):
		...
		# row 0 (buttons 0-8)
		self.button0 = Button(master, text=r1[0], height=3, width=6, command=lambda: self.processPuzzle(self.button0))
		self.button0.grid(row=0, column=0, sticky=N+E+S+W, pady=(20,0), padx=(20,0))
		self.button1 = Button(master, text=r1[1], height=3, width=6, command=lambda: self.processPuzzle(self.button1))
		self.button1.grid(row=0, column=1, sticky=N+E+S+W, pady=(20,0))
		self.button2 = Button(master, text=r1[2], height=3, width=6, command=lambda: self.processPuzzle(self.button2))
		self.button2.grid(row=0, column=2, sticky=N+E+S+W, pady=(20,0))
		self.button3 = Button(master, text=r1[3], height=3, width=6, command=lambda: self.processPuzzle(self.button3))
		self.button3.grid(row=0, column=3, sticky=N+E+S+W, pady=(20,0))
		self.button4 = Button(master, text=r1[4], height=3, width=6, command=lambda: self.processPuzzle(self.button4))
		self.button4.grid(row=0, column=4,sticky=N+E+S+W, pady=(20,0))
		self.button5 = Button(master, text=r1[5], height=3, width=6, command=lambda: self.processPuzzle(self.button5))
		self.button5.grid(row=0, column=5, sticky=N+E+S+W, pady=(20,0))
		self.button6 = Button(master, text=r1[6], height=3, width=6, command=lambda: self.processPuzzle(self.button6))
		self.button6.grid(row=0, column=6, sticky=N+E+S+W, pady=(20,0))
		self.button7 = Button(master, text=r1[7], height=3, width=6, command=lambda: self.processPuzzle(self.button7))
		self.button7.grid(row=0, column=7, sticky=N+E+S+W, pady=(20,0))
		self.button8 = Button(master, text=r1[8], height=3, width=6, command=lambda: self.processPuzzle(self.button8))
		self.button8.grid(row=0, column=8, sticky=N+E+S+W, pady=(20,0))

		# row 1 (buttons 9-17)
		self.button9 = Button(master, text=r2[0], height=3, width=6, command=lambda: self.processPuzzle(self.button9))
		self.button9.grid(row=1, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button10 = Button(master, text=r2[1], height=3, width=6, command=lambda: self.processPuzzle(self.button10))
		self.button10.grid(row=1, column=1, sticky=N+E+S+W)
		self.button11 = Button(master, text=r2[2], height=3, width=6, command=lambda: self.processPuzzle(self.button11))
		self.button11.grid(row=1, column=2, sticky=N+E+S+W)
		self.button12 = Button(master, text=r2[3], height=3, width=6, command=lambda: self.processPuzzle(self.button12))
		self.button12.grid(row=1, column=3, sticky=N+E+S+W)
		self.button13 = Button(master, text=r2[4], height=3, width=6, command=lambda: self.processPuzzle(self.button13))
		self.button13.grid(row=1, column=4, sticky=N+E+S+W)
		self.button14 = Button(master, text=r2[5], height=3, width=6, command=lambda: self.processPuzzle(self.button14))
		self.button14.grid(row=1, column=5, sticky=N+E+S+W)
		self.button15 = Button(master, text=r2[6], height=3, width=6, command=lambda: self.processPuzzle(self.button15))
		self.button15.grid(row=1, column=6, sticky=N+E+S+W)
		self.button16 = Button(master, text=r2[7], height=3, width=6, command=lambda: self.processPuzzle(self.button16))
		self.button16.grid(row=1, column=7, sticky=N+E+S+W)
		self.button17 = Button(master, text=r2[8], height=3, width=6, command=lambda: self.processPuzzle(self.button17))
		self.button17.grid(row=1, column=8, sticky=N+E+S+W)

		# row 2 (buttons 18-26)
		self.button18 = Button(master, text=r3[0], height=3, width=6, command=lambda: self.processPuzzle(self.button18))
		self.button18.grid(row=2, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button19 = Button(master, text=r3[1], height=3, width=6, command=lambda: self.processPuzzle(self.button19))
		self.button19.grid(row=2, column=1, sticky=N+E+S+W)
		self.button20 = Button(master, text=r3[2], height=3, width=6, command=lambda: self.processPuzzle(self.button20))
		self.button20.grid(row=2, column=2, sticky=N+E+S+W)
		self.button21 = Button(master, text=r3[3], height=3, width=6, command=lambda: self.processPuzzle(self.button21))
		self.button21.grid(row=2, column=3, sticky=N+E+S+W)
		self.button22 = Button(master, text=r3[4], height=3, width=6, command=lambda: self.processPuzzle(self.button22))
		self.button22.grid(row=2, column=4, sticky=N+E+S+W)
		self.button23 = Button(master, text=r3[5], height=3, width=6, command=lambda: self.processPuzzle(self.button23))
		self.button23.grid(row=2, column=5, sticky=N+E+S+W)
		self.button24 = Button(master, text=r3[6], height=3, width=6, command=lambda: self.processPuzzle(self.button24))
		self.button24.grid(row=2, column=6, sticky=N+E+S+W)
		self.button25 = Button(master, text=r3[7], height=3, width=6, command=lambda: self.processPuzzle(self.button25))
		self.button25.grid(row=2, column=7, sticky=N+E+S+W)
		self.button26 = Button(master, text=r3[8], height=3, width=6, command=lambda: self.processPuzzle(self.button26))
		self.button26.grid(row=2, column=8, sticky=N+E+S+W)

		# row 3 (buttons 27-35)
		self.button27 = Button(master, text=r4[0], height=3, width=6, command=lambda: self.processPuzzle(self.button27))
		self.button27.grid(row=3, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button28 = Button(master, text=r4[1], height=3, width=6, command=lambda: self.processPuzzle(self.button28))
		self.button28.grid(row=3, column=1, sticky=N+E+S+W)
		self.button29 = Button(master, text=r4[2], height=3, width=6, command=lambda: self.processPuzzle(self.button29))
		self.button29.grid(row=3, column=2, sticky=N+E+S+W)
		self.button30 = Button(master, text=r4[3], height=3, width=6, command=lambda: self.processPuzzle(self.button30))
		self.button30.grid(row=3, column=3, sticky=N+E+S+W)
		self.button31 = Button(master, text=r4[4], height=3, width=6, command=lambda: self.processPuzzle(self.button31))
		self.button31.grid(row=3, column=4, sticky=N+E+S+W)
		self.button32 = Button(master, text=r4[5], height=3, width=6, command=lambda: self.processPuzzle(self.button32))
		self.button32.grid(row=3, column=5, sticky=N+E+S+W)
		self.button33 = Button(master, text=r4[6], height=3, width=6, command=lambda: self.processPuzzle(self.button33))
		self.button33.grid(row=3, column=6, sticky=N+E+S+W)
		self.button34 = Button(master, text=r4[7], height=3, width=6, command=lambda: self.processPuzzle(self.button34))
		self.button34.grid(row=3, column=7, sticky=N+E+S+W)
		self.button35 = Button(master, text=r4[8], height=3, width=6, command=lambda: self.processPuzzle(self.button35))
		self.button35.grid(row=3, column=8, sticky=N+E+S+W)

		# row 4 (buttons 36-44)
		self.button36 = Button(master, text=r5[0], height=3, width=6, command=lambda: self.processPuzzle(self.button36))
		self.button36.grid(row=4, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button37 = Button(master, text=r5[1], height=3, width=6, command=lambda: self.processPuzzle(self.button37))
		self.button37.grid(row=4, column=1, sticky=N+E+S+W)
		self.button38 = Button(master, text=r5[2], height=3, width=6, command=lambda: self.processPuzzle(self.button38))
		self.button38.grid(row=4, column=2, sticky=N+E+S+W)
		self.button39 = Button(master, text=r5[3], height=3, width=6, command=lambda: self.processPuzzle(self.button39))
		self.button39.grid(row=4, column=3, sticky=N+E+S+W)
		self.button40 = Button(master, text=r5[4], height=3, width=6, command=lambda: self.processPuzzle(self.button40))
		self.button40.grid(row=4, column=4, sticky=N+E+S+W)
		self.button41 = Button(master, text=r5[5], height=3, width=6, command=lambda: self.processPuzzle(self.button41))
		self.button41.grid(row=4, column=5, sticky=N+E+S+W)
		self.button42 = Button(master, text=r5[6], height=3, width=6, command=lambda: self.processPuzzle(self.button42))
		self.button42.grid(row=4, column=6, sticky=N+E+S+W)
		self.button43 = Button(master, text=r5[7], height=3, width=6, command=lambda: self.processPuzzle(self.button43))
		self.button43.grid(row=4, column=7, sticky=N+E+S+W)
		self.button44 = Button(master, text=r5[8], height=3, width=6, command=lambda: self.processPuzzle(self.button44))
		self.button44.grid(row=4, column=8, sticky=N+E+S+W)

		# row 5 (buttons 45-53)
		self.button45 = Button(master, text=r6[0], height=3, width=6, command=lambda: self.processPuzzle(self.button45))
		self.button45.grid(row=5, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button46 = Button(master, text=r6[1], height=3, width=6, command=lambda: self.processPuzzle(self.button46))
		self.button46.grid(row=5, column=1, sticky=N+E+S+W)
		self.button47 = Button(master, text=r6[2], height=3, width=6, command=lambda: self.processPuzzle(self.button47))
		self.button47.grid(row=5, column=2, sticky=N+E+S+W)
		self.button48 = Button(master, text=r6[3], height=3, width=6, command=lambda: self.processPuzzle(self.button48))
		self.button48.grid(row=5, column=3, sticky=N+E+S+W)
		self.button49 = Button(master, text=r6[4], height=3, width=6, command=lambda: self.processPuzzle(self.button49))
		self.button49.grid(row=5, column=4, sticky=N+E+S+W)
		self.button50 = Button(master, text=r6[5], height=3, width=6, command=lambda: self.processPuzzle(self.button50))
		self.button50.grid(row=5, column=5, sticky=N+E+S+W)
		self.button51 = Button(master, text=r6[6], height=3, width=6, command=lambda: self.processPuzzle(self.button51))
		self.button51.grid(row=5, column=6, sticky=N+E+S+W)
		self.button52 = Button(master, text=r6[7], height=3, width=6, command=lambda: self.processPuzzle(self.button52))
		self.button52.grid(row=5, column=7, sticky=N+E+S+W)
		self.button53 = Button(master, text=r6[8], height=3, width=6, command=lambda: self.processPuzzle(self.button53))
		self.button53.grid(row=5, column=8, sticky=N+E+S+W)

		# row 6 (buttons 54-62)
		self.button54 = Button(master, text=r7[0], height=3, width=6, command=lambda: self.processPuzzle(self.button54))
		self.button54.grid(row=6, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button55 = Button(master, text=r7[1], height=3, width=6, command=lambda: self.processPuzzle(self.button55))
		self.button55.grid(row=6, column=1, sticky=N+E+S+W)
		self.button56 = Button(master, text=r7[2], height=3, width=6, command=lambda: self.processPuzzle(self.button56))
		self.button56.grid(row=6, column=2, sticky=N+E+S+W)
		self.button57 = Button(master, text=r7[3], height=3, width=6, command=lambda: self.processPuzzle(self.button57))
		self.button57.grid(row=6, column=3, sticky=N+E+S+W)
		self.button58 = Button(master, text=r7[4], height=3, width=6, command=lambda: self.processPuzzle(self.button58))
		self.button58.grid(row=6, column=4, sticky=N+E+S+W)
		self.button59 = Button(master, text=r7[5], height=3, width=6, command=lambda: self.processPuzzle(self.button59))
		self.button59.grid(row=6, column=5, sticky=N+E+S+W)
		self.button60 = Button(master, text=r7[6], height=3, width=6, command=lambda: self.processPuzzle(self.button60))
		self.button60.grid(row=6, column=6, sticky=N+E+S+W)
		self.button61 = Button(master, text=r7[7], height=3, width=6, command=lambda: self.processPuzzle(self.button61))
		self.button61.grid(row=6, column=7, sticky=N+E+S+W)
		self.button62 = Button(master, text=r7[8], height=3, width=6, command=lambda: self.processPuzzle(self.button62))
		self.button62.grid(row=6, column=8, sticky=N+E+S+W)

		# row 7 (buttons 63-71)
		self.button63 = Button(master, text=r8[0], height=3, width=6, command=lambda: self.processPuzzle(self.button63))
		self.button63.grid(row=7, column=0, sticky=N+E+S+W, padx=(20,0))
		self.button64 = Button(master, text=r8[1], height=3, width=6, command=lambda: self.processPuzzle(self.button64))
		self.button64.grid(row=7, column=1, sticky=N+E+S+W)
		self.button65 = Button(master, text=r8[2], height=3, width=6, command=lambda: self.processPuzzle(self.button65))
		self.button65.grid(row=7, column=2, sticky=N+E+S+W)
		self.button66 = Button(master, text=r8[3], height=3, width=6, command=lambda: self.processPuzzle(self.button66))
		self.button66.grid(row=7, column=3, sticky=N+E+S+W)
		self.button67 = Button(master, text=r8[4], height=3, width=6, command=lambda: self.processPuzzle(self.button67))
		self.button67.grid(row=7, column=4, sticky=N+E+S+W)
		self.button68 = Button(master, text=r8[5], height=3, width=6, command=lambda: self.processPuzzle(self.button68))
		self.button68.grid(row=7, column=5, sticky=N+E+S+W)
		self.button69 = Button(master, text=r8[6], height=3, width=6, command=lambda: self.processPuzzle(self.button69))
		self.button69.grid(row=7, column=6, sticky=N+E+S+W)
		self.button70 = Button(master, text=r8[7], height=3, width=6, command=lambda: self.processPuzzle(self.button70))
		self.button70.grid(row=7, column=7, sticky=N+E+S+W)
		self.button71 = Button(master, text=r8[8], height=3, width=6, command=lambda: self.processPuzzle(self.button71))
		self.button71.grid(row=7, column=8, sticky=N+E+S+W)

		# row 8 (buttons 72-80)
		self.button72 = Button(master, text=r9[0], height=3, width=6, command=lambda: self.processPuzzle(self.button72))
		self.button72.grid(row=8, column=0, sticky=N+E+S+W, pady=(0,20), padx=(20,0))
		self.button73 = Button(master, text=r9[1], height=3, width=6, command=lambda: self.processPuzzle(self.button73))
		self.button73.grid(row=8, column=1, sticky=N+E+S+W, pady=(0,20))
		self.button74 = Button(master, text=r9[2], height=3, width=6, command=lambda: self.processPuzzle(self.button74))
		self.button74.grid(row=8, column=2, sticky=N+E+S+W, pady=(0,20))
		self.button75 = Button(master, text=r9[3], height=3, width=6, command=lambda: self.processPuzzle(self.button75))
		self.button75.grid(row=8, column=3, sticky=N+E+S+W, pady=(0,20))
		self.button76 = Button(master, text=r9[4], height=3, width=6, command=lambda: self.processPuzzle(self.button76))
		self.button76.grid(row=8, column=4, sticky=N+E+S+W, pady=(0,20))
		self.button77 = Button(master, text=r9[5], height=3, width=6, command=lambda: self.processPuzzle(self.button77))
		self.button77.grid(row=8, column=5, sticky=N+E+S+W, pady=(0,20))
		self.button78 = Button(master, text=r9[6], height=3, width=6, command=lambda: self.processPuzzle(self.button78))
		self.button78.grid(row=8, column=6, sticky=N+E+S+W, pady=(0,20))
		self.button79 = Button(master, text=r9[7], height=3, width=6, command=lambda: self.processPuzzle(self.button79))
		self.button79.grid(row=8, column=7, sticky=N+E+S+W, pady=(0,20))
		self.button80 = Button(master, text=r9[8], height=3, width=6, command=lambda: self.processPuzzle(self.button80))
